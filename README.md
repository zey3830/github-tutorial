...
---
## Repository Setup
1. Go into your IDE, create a directory using "mkdir" then use "cd" to move into that directory ![tutorial folder](/project_school/github-tutorial/image/tutorial_folder.PNG)
